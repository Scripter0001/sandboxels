// Register the new Sandbloxel block as a land block
const Sandbloxel = new Block({
    name: "sandbloxel",  // Name of the block
  ...
  // Register the Sandbloxel block to the game
  registerBlock(Sandbloxel);
